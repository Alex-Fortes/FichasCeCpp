/* 
	03 -> Classe "Produto": "Setters" e "Getters"
	Eunciado:	crie	um	programa/classe. Nesse programa crie uma classe 
	...
	construtores e um destructor. Neste exercício acrescente o código dos 
	"setters" e "getters" da classe. O programa deve ler os dados de um 
	produto e apresenta-los no monitor utilizando os "setters" e os "getters" 
	criados.
*/
